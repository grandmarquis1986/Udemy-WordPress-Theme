...
{
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyB-hPA3jZhq-yUA8_IXiYhc4m1WTZ1_i-I', NULL, '1.0', true);
...
function universityMapKey($api) {
    $api['key'] = 'AIzaSyB-hPA3jZhq-yUA8_IXiYhc4m1WTZ1_i-I';
    return $api;
}
